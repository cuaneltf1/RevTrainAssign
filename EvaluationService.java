...
public class EvaluationService {
	...
	static class RotationalCipher {
		...
		public String rotate(String string) {
			// makes the list of the alphabet
//			if(Character.isLowerCase(string))
			List<String> omega = Arrays.asList("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n",
					"o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z");
			// moves the list by the key
			Collections.rotate(omega, key);
			System.out.println(omega);
			// Uses modules like magic
			int rotate = key % 26;
			System.out.println(rotate);
			String stars = omega.get(rotate);
